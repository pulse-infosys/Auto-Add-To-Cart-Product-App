...
export async function loader({ request, params }) {
  ...
  const rule = await prisma.cartRule.findFirst({
    where: { 
      id: params.id,
      shop: session.shop 
    }
...
export default function EditRule() {
  ...
  const [hasUpperLimit, setHasUpperLimit] = useState(rule.hasUpperLimit);
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif", maxWidth: "800px" }}>
      <div style={{ marginBottom: "30px" }}>
        ...
        <h1 style={{ margin: "10px 0 0 0", fontSize: "24px", fontWeight: "bold" }}>Edit Rule</h1>
      </div>
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <input
              ...
              min="0"
              step="0.01"
              defaultValue={rule.minCartValue}
              style={{
                width: "100%",
                padding: "12px",
                border: "1px solid #ddd",
          ...
          {hasUpperLimit && (
            <div style={{ marginBottom: "16px", marginLeft: "24px" }}>
              ...
              <input
                ...
                min="0"
                step="0.01"
                defaultValue={rule.maxCartValue || ""}
                style={{
                  width: "100%",
                  padding: "12px",
                  border: "1px solid #ddd",
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          <div style={{ 
            ...
            <input
              ...
              name="productIds"
              required
              defaultValue={JSON.parse(rule.productIds || '[]').join(', ')}
              style={{
                width: "100%",
                padding: "12px",
                border: "1px solid #ddd",
          ...
          <div style={{ display: "grid", gap: "12px" }}>
            <label style={{ display: "flex", alignItems: "flex-start", gap: "8px", cursor: "pointer" }}>
              <input
                type="checkbox"
                name="worksInReverse"
                defaultChecked={rule.worksInReverse}
            ...
            <label style={{ display: "flex", alignItems: "flex-start", gap: "8px", cursor: "pointer" }}>
              <input
                ...
                defaultChecked={rule.allowMultipleTriggers}
                style={{ width: "16px", height: "16px", marginTop: "2px" }}
              />
              <div>
            ...
            <label style={{ display: "flex", alignItems: "flex-start", gap: "8px", cursor: "pointer" }}>
              <input
                ...
                defaultChecked={rule.executeOncePerSession}
                style={{ width: "16px", height: "16px", marginTop: "2px" }}
              />
              <div>
            ...
            <label style={{ display: "flex", alignItems: "flex-start", gap: "8px", cursor: "pointer" }}>
              <input
                ...
                defaultChecked={rule.preventQuantityChanges}
                style={{ width: "16px", height: "16px", marginTop: "2px" }}
              />
              <div>
